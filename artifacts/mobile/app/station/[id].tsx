...
const styles = StyleSheet.create({
  ...
  heroSection:  { minHeight: 250, justifyContent: 'space-between', paddingHorizontal: 20, paddingBottom: 20 },
  ...
  heroBottom:   { gap: 8, paddingBottom: 4 },
  ...
  content:      { padding: 16, gap: 16, marginTop: 4 },
